...
const I18N = {
  ...
  fr: {
    ...
    howto_intro:'Crée un cadeau 3dxchat en 3 clics rapides :',
    howto_step1:'<b>Clique un modèle</b> à droite — catégories Sweet, Flirty, Spicy, etc. Ton texte s\'affiche tout de suite.',
    howto_step2:'<b>Personnalise (optionnel)</b> — modifie les champs à gauche, change les couleurs via le carré coloré à côté de chaque champ, ou choisis une autre Disposition.',
    howto_step3:'<b>Copie le code</b> sous l\'aperçu, colle-le dans 3dxchat comme message cadeau. C\'est fait !',
    howto_extras_title:'Bon à savoir',
    howto_extras:'<li>Clique une ligne dans l\'<b>aperçu</b> pour sauter directement au champ correspondant.</li><li>L\'<b>★</b> à côté d\'un modèle le sauvegarde en favori (apparaît en haut de la liste).</li><li><b>Share</b> copie un lien dans ton presse-papiers — quiconque l\'ouvre voit ton cadeau exact dans son générateur.</li><li>Le <b>compteur</b> en haut reste vert si ton cadeau respecte la limite (240 car. / 255 octets). Jaune = attention, rouge = trop long.</li>',
    layout:'Disposition',
