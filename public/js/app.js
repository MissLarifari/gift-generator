...
const I18N = {
  ...
  fr: {
    ...
    howto_extras:'<li>Clique une ligne dans l\'<b>aperçu</b> pour sauter directement au champ correspondant.</li><li>Besoin de réordonner les lignes ? Clique le bouton violet <b>↕ Réordonner</b> au-dessus de l\'aperçu — les flèches ↑ ↓ × apparaissent à côté de chaque ligne. Clique <b>✓ Terminé</b> pour finir.</li><li>L\'<b>★</b> à côté d\'un modèle le sauvegarde en favori (apparaît en haut de la liste).</li><li><b>Share</b> copie un lien dans ton presse-papiers — quiconque l\'ouvre voit ton cadeau exact dans son générateur.</li><li>Le <b>compteur</b> en haut reste vert si ton cadeau respecte la limite (240 car. / 255 octets). Jaune = attention, rouge = trop long.</li>',
    layout:'Disposition',
