...
const I18N = {
  ...
  de: {
    ...
    howto_step1:'<b>Wähle ein Layout</b> — oder <b>Eigenes</b> zum komplett freien Schreiben.',
    ...
    howto_step_reorder:'<b>Zeilen umsortieren</b> in der Vorschau — geh mit der Maus über eine Zeile und nutze <b>▲ ▼</b> zum Verschieben oder <b>✕</b> zum Entfernen.',
    howto_step6:'<b>Kopier</b> den Code und füg ihn in 3dxchat als Gift-Nachricht ein. <b>Share</b> kopiert dir einen Link in die Zwischenablage — darin steckt dein komplettes Gift (Text, Farben, Layout, Schriftarten). Wer den Link öffnet, sieht dein Gift direkt in seinem Generator und kann es übernehmen, anpassen oder selbst weitergeben.',
    howto_tip:'Tipp — klick eine Zeile in der Vorschau, um sie zu bearbeiten. Der Zähler zeigt, ob dein Text noch passt.',
    layout:'Layout',
