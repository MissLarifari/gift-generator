/* eslint-disable react-hooks/refs -- Aus dem Stand vor dem Umbau zurueckgeholt
   (b81462d). Der Compiler-Regelsatz kam spaeter: er bemaengelt die Knopf-
   Erzeugung im Render, weil deren Klick-Funktionen taRef lesen. Gelesen wird
   erst beim Klick, nicht beim Zeichnen — die Oberflaeche lief so monatelang
   live. Umbauen erst, wenn sie ohnehin angefasst wird. */
