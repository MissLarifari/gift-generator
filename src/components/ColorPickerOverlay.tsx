/* eslint-disable react-hooks/set-state-in-effect -- Aus dem Stand vor dem
   Umbau zurueckgeholt (b81462d). Der Effekt setzt den Farbzustand neu, wenn
   das Fenster fuer ein anderes Feld aufgeht; genau dafuer ist er da. Lief so
   live, Regelsatz kam spaeter. */
